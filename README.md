...
customer-flow job in Convex. The same Convex mutation creates one PII-free work
item containing only a private job reference. A local bridge claims that item
